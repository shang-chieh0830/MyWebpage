...
- Math, Stat, and Programming
  ...
  Calculus (A+/A+), Statistics (A+/A+), Linear Algebra (A+/A-), Applications of Differential Equation (A+), Advanced Calculus (A+/A), Mathematical Statistics (A+/A+), Multivariate Analysis (A+), Econometrics (I)/(II) (A+/A+), Business Analytics with SAS/R (A+), Theory of Statistics (Ⅰ)  (A+), Introduction to Numerical Methods in Economics and Econometrics (A+), Applied Financial Econometrics (A+)
  
- Econ and Finance

  Economics (A+/A+), Microeconomics (A+/A+), Macroeconomics (A+/A+), Public Finance (A+/A+), Money and Banking (A+/A+), Financial Management (A+), International Finance (A+), Labor Economics (A+), Industrial Economics (A+) 
